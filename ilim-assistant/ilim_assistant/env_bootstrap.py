...
def ensure_ruzgar_env() -> list[str]:
    ...
    if os.environ.get("RUZGAR_UMED_CEVAP_EMRI", "1").strip().lower() not in (
        ...
        os.environ.setdefault("RUZGAR_WEB_FIRST", "1")
        os.environ.setdefault("RUZGAR_WEB_FIRST_MAX_RESULTS", "8")
        os.environ.setdefault("RUZGAR_WEB_FIRST_FETCH_URLS", "0")
        os.environ.setdefault("RUZGAR_WEB_FIRST_NEWS", "1")
        os.environ.setdefault("RUZGAR_WEB_FIRST_MIN_COVERAGE", "0.22")
        os.environ.setdefault("RUZGAR_WEB_FIRST_MIN_RELEVANCE", "1.4")
