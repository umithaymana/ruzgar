...
Okuma motoru Kultur ve Ilim Hazinesi vizyonuyla (dort kuliyat arsivi + metin turu) beslenir.
...
def build_core_context(message: str) -> str:
    from ilim_assistant.okuma_motoru import build_motor_context as okuma_context
    ...
    parts.extend(
        ...
        "Bu merkez; Ses, Video, Okuma, Tercume ve Programlama motorlarini birlikte kullanir.",
